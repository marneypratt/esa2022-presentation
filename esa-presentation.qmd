...
## Raising the Bar: {style="text-align: center;"}

### Learning and Teaching Better {style="text-align: center;"}
### Data Visualization in R {style="text-align: center;"}

\

[Presented by Marney Pratt & June Arriens]{style="text-align: center;"}

[Contributions by Audrey McCombs & Dan Turner]{style="text-align: center;"}

[August 16, 2022]{style="text-align: center;"}

\

Raise The Bar Interactive Website: [https://raisethebar.netlify.app/](https://raisethebar.netlify.app/)

email questions to: [mcpratt\@smith.edu]{style="color: blue"}
...
![Let's answer some questions on the website about mussel size using this bar graph:](images/length.png){fig-alt="bar graph of mean shell lengths with standard errors" fig-align="center" width="60%"}
...
#### What Graph to Choose When You Have a {style="text-align: center;"}

#### Categorical Independent Variable {style="text-align: center;"}
